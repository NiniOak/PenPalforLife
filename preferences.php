...
<body>
    ...
    <div id="wrapper">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="alert alert-info alert-dismissable">
                            ...
                            <i class="fa fa-info-circle"></i>  <strong>Interests updated successfully!</strong>
                        </div>
                    </div>
                </div>
        ...
        <!-- dropdown list of preferences -->
        <div class="form-group">
             <label>Interests</label>
                <form method="POST" action="index.php">

                   <select multiple class="form-control" name="something[]" multiple="multiple" tabindex="1">
                        <option id="Skiing" value="Skiing">Skiing</option>
                        <option id="Racing">Racing</option>
                        <option id="Cycling">Cycling</option>
                        <option id="Gymnastics">Gymnastics</option>
                        <option id="Dancing">Dancing</option>
                        <option id="Painting">Painting</option>
                        <option id="Singing">Singing</option>
                        <option id="Creative Writing">Creative Writing</option>
                        <option id="Drawing">Drawing</option>
                        <option id="Computer Games">Computer games</option>
                        <option id="internet Browsing">Internet browsing</option>
                        <option id="Video Games">Video games</option>
                        <option id="camping">Camping</option>
                        <option id="Swimming">Swimming </option>
                        <option id="Bowling">Bowling</option>
                        <option id="ping pong">Ping pong</option>
                        <option id="Star gazing">Star gazing</option>
                        <option id="Reading">Reading</option>
                        <option id="Jumping rope">Jumping rope</option>
                    </select>
