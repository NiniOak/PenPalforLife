                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <div class="col-md-4">
                                    <img src="images/femaledwarfhead.png"  alt="profile picture" id="profileimage">
                                </div>
                            </div>
                            <!-- profile Image -->
                             <div class="panel-body">
                                ...
                                <div class="text-right">
                                    <a href="character_select.php">Change Image <i class="fa fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                        </div>
                            </div>
                                    ...
                                    <a href="character_select.php"><img src="images/user.png" class="name"
                                     ...
                                     <a href="preferences.php"><img src="images/edit.png" class="preferences"
                                           ...
                                           <div class="name" style="margin-left: 60px;">
                                                 ...
                                                 <?php
                                                    foreach ($_POST['something'] as $select)
                                                    {
                                                        if(isset($select)) {
                                                            echo $select , " , " ; // Displaying Selected Value
